...
function setupInitialCameraPose(dirUrl) {
  initialPoses = {
    'default': {
      'position': [1.0572422079531185, 1.1450230804419899, -1.0658001699916813],
      'lookat': [-0.12427573349458583, -0.16569971756322313, -0.045847564605149084],  
    },
    'gardenvase': {
      'position':
  ...
  function setCameraPose(d) {
    ...
    gOrbitControls.target.x = d['lookat'][0];
    gOrbitControls.target.y = d['lookat'][1];
    gOrbitControls.target.z = d['lookat'][2];
